...
import wsf.interceptor.ResourcesInterceptor;
...
public class SpringMvcConfig  implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor( resourcesInterceptor()).addPathPatterns("/**","/book/**").excludePathPatterns("/css/**","/js/**","/img/**");
    }
